...
public:
    ...
    void setupUi(QDialog *Dlg_addDish)
    {
        ...
        label = new QLabel(Dlg_addDish);
        label->setObjectName("label");
        label->setGeometry(QRect(50, 50, 69, 20));
        QFont font;
        ...
        le_id = new QLineEdit(Dlg_addDish);
        le_id->setObjectName("le_id");
        le_id->setGeometry(QRect(100, 50, 181, 21));
    ...
    void retranslateUi(QDialog *Dlg_addDish)
    {
        ...
        label->setText(QCoreApplication::translate("Dlg_addDish", "\347\274\226\345\217\267", nullptr));
